use super::time::{Microseconds, U32Ext};
...
pub struct Stepper<E: OutputPin, D: OutputPin, S: OutputPin> {
    enable: E,
    direction: D,
    step: S,
    state: PinState,
...
impl<E: OutputPin, D: OutputPin, S: OutputPin> Stepper<E, D, S> {
    pub fn init(enable: E, direction: D, step: S) -> Self {
        let mut motor = Self {
            enable,
            direction,
            step,
        ...
        let _ = motor.direction.set_high();
    ...
    pub fn update_angle(
        ...
        // get movement
        let dif: i32 = (STEPS_PER_RESOLUTION_I16_HALF - new_val) as i32;
